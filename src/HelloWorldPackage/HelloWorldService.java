 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://HelloWorldPackage/", wsdlLocation = "http://localhost:9000/HelloWorldPackage.HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://HelloWorldPackage/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/HelloWorldPackage.HelloWorld?wsdl");
    ...
    public IHelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://HelloWorldPackage/", "HelloWorldPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://HelloWorldPackage/", "HelloWorldPort"), IHelloWorld.class, features);
    }
