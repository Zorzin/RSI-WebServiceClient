 ...
 * generated in the helloworldpackage package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://HelloWorldPackage/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://HelloWorldPackage/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: helloworldpackage
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloWorldPackage/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloWorldPackage/", name = "getHelloWorldAsStringResponse")
